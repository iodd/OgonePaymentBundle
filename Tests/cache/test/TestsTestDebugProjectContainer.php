...
class TestsTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YfMBlEwNFe', '', (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z9JqtpbDbx', '', 'EucHPf0OAdvYMLKB7wQ2IA', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z6EOumDGm7', '', 'EucHPf0OAdvYMLKB7wQ2IA', (__DIR__.'/pools'), NULL));
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('za6CZOYHLw', '', 'EucHPf0OAdvYMLKB7wQ2IA', (__DIR__.'/pools'), NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ogone', 'user' => 'root', 'password' => 'qsz3wdx', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/Entity'))), 'Pilot\\OgonePaymentBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PilotOgonePaymentBundle' => 'Pilot\\OgonePaymentBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7cfb0a903115353f95851e1c26f2213e07ab66eec0ddbf9ee0f59d08f81eabc9');
    ...
    {
        return $this->services['ogone.feedbacker'] = new \Pilot\OgonePaymentBundle\Feedback\TransactionFeedbacker($this->get('request_stack'), $this->get('ogone.secure_configuration'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/Resources/views'), 'PilotOgonePayment');
